...
### 1. 访问仓库首页
   <img src="./figures/step1.png" alt="step1" width="80%"/>
...
### 3. 新建个人汇报文件夹  
   ...
   <img src="./figures/step2.png" alt="step2" width="60%"/>
...
### 5. 提交并生成新分支  
   ...
   <img src="./figures/step4_1.png" alt="step4_1" width="60%"/>  
   点击 `Commit & Push`  
   创建新分支  
   <img src="./figures/step4_2.png" alt="step4_2" width="30%"/>
   <img src="./figures/step4_3.png" alt="step4_3" width="30%"/>  


### 6. 发起 Pull Request  
   左侧打开 `Source Control` 面板 → 点击**创建拉取请求**  
   <img src="./figures/step5_1.png" alt="step5_1" width="60%"/>  
